...
<div style="border-width:8px; rgba(0,0,0,0.5); border-color:#800000; width:100%;">
</div>
...
<h1>
      ...
      <iframe src="https://scratch.mit.edu/projects/415874481/embed" allowtransparency="true" width="100%" height="50%" frameborder="0" scrolling="no" allowfullscreen></iframe>
      ...
      <b>コメント</b><br>
ただ音楽がかっこいい<br>
      <a href="https://dova-s.jp/_mobile/bgm/play4590.html">dova-syndromeから音源をダウンロード(はるはるtv外部サイト)</a>
<hr>
      <style>
        .icon{
bottom        : 20px;        /* 下から位置 */
...
bottom        : 20px;        /* 下から位置 */
  ...
  z-index       : 999;         /* 重ね順位   */
    ...
    <a href="https://smn.glitch.me/App">はるはるアプリシリーズ</a>
